...
from citation_cff_checker import __version__ as the_version
from citation_cff_checker import __author__ as the_author
from citation_cff_checker import __license__ as the_license
from citation_cff_checker import __url__ as the_url
...
package_data = {
    "citation_cff_checker": [
        "py.typed",
    ],
}

setuptools.setup(
    name="citation_cff_checker",
    version=the_version,
    scripts=["cff-ver-validate.py"],
    ...
    entry_points={
        "console_scripts": [
            "cff-ver-validate=citation_cff_checker.__main__:main",
        ],
    },
    classifiers=[
